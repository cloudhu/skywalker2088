...
pub(crate) use self::consumable::{ConsumableData, ConsumableResource, SpawnConsumableEvent};
pub(crate) use self::effect::{EffectsResource, SpawnEffectEvent};
pub(crate) use self::mob::{BossesDestroyedEvent, MobComponent, MobSegmentComponent};
pub(crate) use self::projectile::{FireWeaponEvent, ProjectileData, ProjectileResource};
...
/// Despawns entities when their `DespawnTimerComponent` expires.
