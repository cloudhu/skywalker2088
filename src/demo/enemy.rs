...
use crate::demo::enemy_animation::EnemyAnimation;
...
fn spawn_player(
    ...
    let player_animation = EnemyAnimation::new();
...
fn record_player_directional_input(
    ...
    mut controller_query: Query<&mut MovementController, With<Enemy>>,
) {
...
impl FromWorld for EnemyAssets {
    fn from_world(world: &mut World) -> Self {
        ...
        Self {
            ...
            steps: vec![
                assets.load(EnemyAssets::PATH_STEP_1),
                assets.load(EnemyAssets::PATH_STEP_2),
                assets.load(EnemyAssets::PATH_STEP_3),
                assets.load(EnemyAssets::PATH_STEP_4),
            ],
        }
    }
}
