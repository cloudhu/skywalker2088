                ...
                .with_children(|ability_icon_ui| {
                    ability_icon_ui
                        .spawn(NodeBundle {
                            ...
                            background_color: Colour::BLACK.with_alpha(0.85).into(),
                            ..default()
                        })
                        .insert(player_id)
        ...
        .with_children(|inner_ui| {
            inner_ui
                .spawn(NodeBundle {
                    ...
                    background_color: Colour::RED.with_alpha(0.05).into(),
                    ..default()
                })
                .insert(HealthUI)
                .with_children(|health_ui| {
                    health_ui
                        .spawn(NodeBundle {
                            ...
                            background_color: Colour::GREEN.with_alpha(0.75).into(),
                            ..default()
                        })
            ...
            inner_ui
                .spawn(NodeBundle {
                    ...
                    background_color: Colour::SHIELD.with_alpha(0.05).into(),
                    ..default()
                })
                .insert(ShieldsUI)
                .with_children(|shields_ui| {
                    shields_ui
                        .spawn(NodeBundle {
                            ...
                            background_color: Colour::SHIELD.with_alpha(0.75).into(),
                            ..default()
                        })
...
fn build_armor_counter(parent: &mut ChildBuilder) {
    parent
        .spawn(NodeBundle {
            ...
            background_color: Colour::PLAYER.with_alpha(0.75).into(),
            ..default()
        })
