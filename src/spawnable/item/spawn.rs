...
use bevy::prelude::{
    in_state, App, Commands, EventReader, IntoSystemConfigs, Name, Plugin, Res, StateScoped, Timer,
    TimerMode, Transform, Update, Vec2, Vec3,
};
...
pub fn spawn_item(
    ...
    item.insert(StateScoped(AppStates::Game));
